...
# Label Cube
labelcube = Cube(joinpath(path,"mergedlabels_ranked_pot0.01_ne0.1_cmp_S1_T3_1950_2023.zarr"))#[time = Date(2001) .. Date(2010), latitude = 45.0 .. 46.0, longitude = 15.0 .. 16.0]
outpath = joinpath(path,"AnnualMaxLabel_ranked_pot0.01_ne0.1_cmp_S1_T3.zarr")
